...
public class MyCursosRecyclerViewAdapter extends RecyclerView.Adapter<MyCursosRecyclerViewAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_cursos_list, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        if (holder.mItem.getQuienImparte()=="UPV" ){
            Glide
                    .with(ctx)
                    .load(urlUPV)
                    .centerCrop()
                    .into(holder.logoEmpresa);
        }else if (holder.mItem.getQuienImparte()=="OpenWebinar"){
            Glide
                    .with(this.ctx)
                    .load(urlOpenWebinar)
                    .centerCrop()
                    .into(holder.logoEmpresa);
        }else if (holder.mItem.getQuienImparte()=="keepCoding"){
            Glide
                    .with(ctx)
                    .load(urlKeepCoding)
                    .into(holder.logoEmpresa);
        }else if (holder.mItem.getQuienImparte()=="AppBrewery"){
            Glide
                    .with(ctx)
                    .load(urlAppBrewery)
                    .into(holder.logoEmpresa);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mView = view;
            tituloCurso = (TextView) view.findViewById(R.id.titulos_centro);
